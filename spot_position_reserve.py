...
def get_spot_position_reserve_bybit():
...
def get_spot_position_reserve_zapper():
    ...
    total_balance = float(data['data']['portfolioV2']['tokenBalances']['totalBalanceUSD'])
...
def total_spot_position_reserve():
